//Conexion
const listaProductos = () => fetch('https://palm-toothsome-step.glitch.me/productos').then(respuesta => respuesta.json());

const crearProducto = (nombre, precio, imagen, categoria, descripcion) => {
  return fetch('https://palm-toothsome-step.glitch.me/productos', {
    method: "POST",
    headers: {
...
const eliminarProducto = (id) => {
  return fetch(`https://palm-toothsome-step.glitch.me/productos/${id}`, {
    method: "DELETE"
  });
};
...
const detalleProducto = async (id) => {
  return fetch(`https://palm-toothsome-step.glitch.me/productos/${id}`).then( respuesta => respuesta.json());
};
